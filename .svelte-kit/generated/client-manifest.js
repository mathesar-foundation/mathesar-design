...
export const components = [
	...
	() => import("../../src/routes/schema/[schemaId]/tables/[tableId]/records/[recordId]/RecordNavigation.svelte"),
...
export const dictionary = {
	...
	"schema/[schemaId]/DataType": [[0, 5], [1]],
	"schema/[schemaId]/NavItem": [[0, 6], [1]],
	"schema/[schemaId]/SideBar": [[0, 7], [1]],
	"schema/[schemaId]/Toolbar": [[0, 8], [1]],
	"schema/[schemaId]/queries/[queryId]": [[0, 9], [1]],
	"schema/[schemaId]/queries/[queryId]/BaseTableSelector": [[0, 10], [1]],
	"schema/[schemaId]/queries/[queryId]/FormulaSettings": [[0, 11], [1]],
	"schema/[schemaId]/queries/[queryId]/SelectedColumns": [[0, 12], [1]],
	"schema/[schemaId]/queries/[queryId]/Transformations": [[0, 13], [1]],
	"schema/[schemaId]/queries/[queryId]/ColumnSelector": [[0, 14], [1]],
	"schema/[schemaId]/queries/[queryId]/ColumnSettings": [[0, 15], [1]],
	"schema/[schemaId]/queries/[queryId]/ColumnEditor": [[0, 16], [1]],
	"schema/[schemaId]/queries/[queryId]/TablePreview": [[0, 17], [1]],
	"schema/[schemaId]/queries/[queryId]/ColumnGroup": [[0, 18], [1]],
	"schema/[schemaId]/queries/[queryId]/Parameters": [[0, 19], [1]],
	"schema/[schemaId]/queries/[queryId]/Column": [[0, 20], [1]],
	"schema/[schemaId]/queries/[queryId]/Source": [[0, 21], [1]],
	"schema/[schemaId]/queries/[queryId]/Step": [[0, 22], [1]],
	"schema/[schemaId]/Column": [[0, 23], [1]],
	"schema/[schemaId]/Editor": [[0, 24], [1]],
	"schema/[schemaId]/tables/DataTypeSettings": [[0, 25], [1]],
	"schema/[schemaId]/tables/SelectionActions": [[0, 26], [1]],
	"schema/[schemaId]/tables/LinkTableWizard": [[0, 27], [1]],
	"schema/[schemaId]/tables/RecordSelector": [[0, 28], [1]],
	"schema/[schemaId]/tables/LinkTableForm": [[0, 29], [1]],
	"schema/[schemaId]/tables/ColumnCard": [[0, 30], [1]],
	"schema/[schemaId]/tables/ImportData": [[0, 31], [1]],
	"schema/[schemaId]/tables/Inspector": [[0, 32], [1]],
	"schema/[schemaId]/tables/Question": [[0, 33], [1]],
	"schema/[schemaId]/tables/Design": [[0, 34], [1]],
	"schema/[schemaId]/tables/Filter": [[0, 35], [1]],
	"schema/[schemaId]/tables/Popup": [[0, 36], [1]],
	"schema/[schemaId]/tables/Query": [[0, 37], [1]],
	"schema/[schemaId]/tables/[tableId]": [[0, 38], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]": [[0, 39], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]/RecordNavigation": [[0, 40], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]/EmbeddedQueries": [[0, 41], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]/[queryId]": [[0, 42], [1]],
	"schema/[schemaId]/Table": [[0, 43], [1]],
	"schema/[schemaId]/views/[viewId]": [[0, 44], [1]],
	"schema/[schemaId]/Cell": [[0, 45], [1]],
	"schema/[schemaId]/Tabs": [[0, 46], [1]]
};