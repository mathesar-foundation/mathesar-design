...
export const dictionary = {
	...
	"schema/[schemaId]/queries/[queryId]/Parameters": [[0, 17], [1]],
	"schema/[schemaId]/queries/[queryId]/Column": [[0, 18], [1]],
	"schema/[schemaId]/queries/[queryId]/Source": [[0, 19], [1]],
	"schema/[schemaId]/queries/[queryId]/Step": [[0, 20], [1]],
	"schema/[schemaId]/Column": [[0, 21], [1]],
	"schema/[schemaId]/tables/LinkTableWizard": [[0, 22], [1]],
	"schema/[schemaId]/tables/RecordSelector": [[0, 23], [1]],
	"schema/[schemaId]/tables/LinkTableForm": [[0, 24], [1]],
	"schema/[schemaId]/tables/ColumnCard": [[0, 25], [1]],
	"schema/[schemaId]/tables/ImportData": [[0, 26], [1]],
	"schema/[schemaId]/tables/Inspector": [[0, 27], [1]],
	"schema/[schemaId]/tables/Question": [[0, 28], [1]],
	"schema/[schemaId]/tables/Design": [[0, 29], [1]],
	"schema/[schemaId]/tables/Filter": [[0, 30], [1]],
	"schema/[schemaId]/tables/Popup": [[0, 31], [1]],
	"schema/[schemaId]/tables/Query": [[0, 32], [1]],
	"schema/[schemaId]/tables/[tableId]": [[0, 33], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]": [[0, 34], [1]],
	"schema/[schemaId]/Table": [[0, 35], [1]],
	"schema/[schemaId]/views/[viewId]": [[0, 36], [1]],
	"schema/[schemaId]/Cell": [[0, 37], [1]],
	"schema/[schemaId]/Tabs": [[0, 38], [1]]
};