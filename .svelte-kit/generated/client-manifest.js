...
export const components = [
	...
	() => import("../../src/routes/schema/[schemaId]/tables/[tableId]/records/EmbeddedQueries.svelte"),
	() => import("../../src/routes/schema/[schemaId]/tables/[tableId]/records/[recordId].svelte"),
...
export const dictionary = {
	...
	"schema/[schemaId]/tables/DataTypeSettings": [[0, 23], [1]],
	"schema/[schemaId]/tables/SelectionActions": [[0, 24], [1]],
	"schema/[schemaId]/tables/LinkTableWizard": [[0, 25], [1]],
	"schema/[schemaId]/tables/RecordSelector": [[0, 26], [1]],
	"schema/[schemaId]/tables/LinkTableForm": [[0, 27], [1]],
	"schema/[schemaId]/tables/ColumnCard": [[0, 28], [1]],
	"schema/[schemaId]/tables/ImportData": [[0, 29], [1]],
	"schema/[schemaId]/tables/Inspector": [[0, 30], [1]],
	"schema/[schemaId]/tables/Question": [[0, 31], [1]],
	"schema/[schemaId]/tables/Design": [[0, 32], [1]],
	"schema/[schemaId]/tables/Filter": [[0, 33], [1]],
	"schema/[schemaId]/tables/Popup": [[0, 34], [1]],
	"schema/[schemaId]/tables/Query": [[0, 35], [1]],
	"schema/[schemaId]/tables/[tableId]": [[0, 36], [1]],
	"schema/[schemaId]/tables/[tableId]/records/EmbeddedQueries": [[0, 37], [1]],
	"schema/[schemaId]/tables/[tableId]/records/[recordId]": [[0, 38], [1]],
	"schema/[schemaId]/Table": [[0, 39], [1]],
	"schema/[schemaId]/views/[viewId]": [[0, 40], [1]],
	"schema/[schemaId]/Cell": [[0, 41], [1]],
	"schema/[schemaId]/Tabs": [[0, 42], [1]]
};