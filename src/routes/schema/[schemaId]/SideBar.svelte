...
<div class="flex shrink-0 border">
  ...
  <div class="{theme.mediumBackgroundColor} bg-opacity-30">
    <div class="w-12 h-12 {theme.textColor} cursor-pointer hover:bg-opacity-80 bg-opacity-0 {theme.darkPrimaryColor} flex" on:click={()=>expanded = !expanded}>
...
{#if expanded}
  ...
  >
    ...
    <div>
      ...
      <div>
        <div
          class="p-2 border-b flex items-center {theme.tableBorderColor}"
        >
        ...
        {#each schema.views as table, i}
          ...
          >
            <i class="{icon[table.type]} align-bottom"></i>
