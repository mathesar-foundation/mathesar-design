...
{#if open}
  <div class="modal z-50 fixed w-full h-full top-0 left-0 flex items-center justify-center p-6 lg:p-0">
    ...
    <div class="bg-zinc-50 w-full flex flex-col lg:h-5/6 lg:w-5/6  mx-auto rounded-lg shadow-xl z-50 overflow-y-auto">
      <div class="flex justify-between items-center py-4 px-6 text-xl text-zinc-800">
        <div>
        {title}
        {#if subTitle}
